...
static void *sha1_read_ctx(const struct sha1_ctx *ctx, void *resbuf) {
  char *r = resbuf;
...
static void *sha1_finish_ctx(struct sha1_ctx *ctx, void *resbuf) {
...
/* Compute SHA1 message digest for LEN bytes beginning at BUFFER.  The
   ...
   digest.  */
static void *sha1_buffer(const char *buffer, size_t len, void *resblock) {
  struct sha1_ctx ctx;
